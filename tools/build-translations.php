...
$theme_strings = array(
	...
	'Travel to the Land of Tea' => 'চায়ের দেশে ভ্রমণ করুন',
	'View all' => 'সব দেখুন',
...
$plugin_strings = array(
	...
	'Creates the 21 core Bangladesh destinations (Bengali titles, English URL slugs) if they do not already exist, and tags the Sylhet tea-garden group for the homepage featured section. Safe to run more than once — existing destinations (matched by slug) are never modified or duplicated.'
		=> 'বাংলাদেশের ২১টি মূল গন্তব্য (বাংলা শিরোনাম, ইংরেজি URL স্লাগসহ) তৈরি করে, যদি সেগুলো আগে থেকে না থাকে, এবং হোমপেজের ফিচার্ড সেকশনের জন্য সিলেটের চা-বাগান গ্রুপ ট্যাগ করে দেয়। একাধিকবার চালানো নিরাপদ — বিদ্যমান গন্তব্য (স্লাগ অনুযায়ী মিলিয়ে) কখনও পরিবর্তন বা ডুপ্লিকেট করা হয় না।',
	'Currency' => 'মুদ্রা',
